...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
        ...
        _______, CK_DOWN, CK_TOGG, CK_UP,   _______, KC_TAB,  _______, _______, _______, _______, KC_INS,  _______, _______, _______, _______, _______,
    ...
    [_ADJUST] = LAYOUT(
        ...
        _______, RGB_TOG, RGB_SPI, RGB_VAI, RGB_HUI, RGB_SAI, _______,                   _______, _______, KC_P&,   KC_P8,   KC_P9,   KC_PPLS, _______,
