...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        KC_GRV,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_HOME,                  KC_UP,   KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSPC,
        KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_PGUP,                  KC_LEFT, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS,
        KC_ESC,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_PGDN,                  KC_RGHT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT,  KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,                   KC_DOWN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_LCTL,  KC_MINS, KC_EQL,  KC_LALT, KC_LGUI, KC_SPC,  ADJUST,  FN,     FN,      ADJUST,  KC_ENT,  KC_RGUI, KC_RALT, KC_LBRC, KC_RBRC, KC_RCTL,
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, KC_TAB,  _______, _______, _______, _______, KC_INS,  _______, _______, _______, _______, _______,
    ...
    [_ADJUST] = LAYOUT(
        _______, _______, _______, _______, _______, _______, RESET,                     RESET,   _______, KC_NLCK, KC_PSLS, KC_PAST, KC_PMNS, _______,
        ...
        _______, RGB_RMOD,CK_DOWN, CK_TOGG, CK_UP,   _______, DM_RSTP,                   _______, _______, KC_P1,   KC_P2,   KC_P3,   KC_PEQL, _______,
        _______, NK_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_P0,   KC_P0,   KC_PDOT, KC_PENT, _______,
